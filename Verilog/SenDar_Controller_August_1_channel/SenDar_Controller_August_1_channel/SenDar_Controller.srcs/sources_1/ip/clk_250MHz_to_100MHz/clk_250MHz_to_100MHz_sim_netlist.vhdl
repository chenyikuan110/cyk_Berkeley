...
--               /bwrcq/projects/ykchen/Vivado/SenDar_Controller/SenDar_Controller.srcs/sources_1/ip/clk_250MHz_to_100MHz/clk_250MHz_to_100MHz_sim_netlist.vhdl
...
entity clk_250MHz_to_100MHz_clk_250MHz_to_100MHz_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of clk_250MHz_to_100MHz_clk_250MHz_to_100MHz_clk_wiz : entity is "clk_250MHz_to_100MHz_clk_wiz";
end clk_250MHz_to_100MHz_clk_250MHz_to_100MHz_clk_wiz;

architecture STRUCTURE of clk_250MHz_to_100MHz_clk_250MHz_to_100MHz_clk_wiz is
  signal clk_in1_clk_250MHz_to_100MHz : STD_LOGIC;
  signal clk_out_80MHz_clk_250MHz_to_100MHz : STD_LOGIC;
  signal clkfbout_buf_clk_250MHz_to_100MHz : STD_LOGIC;
  signal clkfbout_clk_250MHz_to_100MHz : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clkfbout_clk_250MHz_to_100MHz,
      O => clkfbout_buf_clk_250MHz_to_100MHz
    );
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_clk_250MHz_to_100MHz
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out_80MHz_clk_250MHz_to_100MHz,
      O => clk_out_80MHz
    );
...
entity clk_250MHz_to_100MHz is
  ...
  attribute NotValidForBitStream of clk_250MHz_to_100MHz : entity is true;
end clk_250MHz_to_100MHz;

architecture STRUCTURE of clk_250MHz_to_100MHz is
begin
inst: entity work.clk_250MHz_to_100MHz_clk_250MHz_to_100MHz_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out_80MHz => clk_out_80MHz
    );
end STRUCTURE;
